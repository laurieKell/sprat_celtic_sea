...
lnd=read.csv("../data/inputs/landings.csv")
survey=read.csv("../data/inputs/spratSurvey.csv")
...
alk<-read.csv("../data/inputs/ALK/sprat_aged_data.csv")

# Celtic Sea ###################################################################
load("../data/inputs/sprat_growth/CM_sprat_vb_param.RData")

# North Sea SMS outputs ########################################################
sms=subset(read.csv("../data/inputs/Assessed_species_details_by_age_and_quarter.csv"),
           Species=="Sprat")
...
m=read.csv("../dataOld/inputs/Sprat_M_TS.csv")
...
p1=ggplot(as.data.frame(m(ices[["spr.27.3a4"]])))+
...
p2=ggplot(as.data.frame(m(ices[["spr.27.3a4"]])))+
...
p1=ggplot(as.data.frame(stock.wt(ices[["spr.27.3a4"]])))+
  geom_line(aes(year,data,col=ac(age)),size=1.2)+
  scale_y_continuous(limits=c(0,NA))+
...
p2=ggplot(as.data.frame(stock.wt(ices[["spr.27.3a4"]])))+
  geom_boxplot(aes(ac(age),data,fill=ac(age)))+
  geom_smooth( aes(   age+1 ,data),se=F)+
  scale_y_continuous(limits=c(0,NA))+
  xlab("Age")+ylab("")+
...
p1=ggplot(as.data.frame(catch.wt(ices[["spr.27.3a4"]])))+
  geom_line(aes(year,data,col=ac(age)),size=1.2)+
  scale_y_continuous(limits=c(0,NA))+
...
p2=ggplot(as.data.frame(catch.wt(ices[["spr.27.3a4"]])))+
  geom_boxplot(aes(ac(age),data,fill=ac(age)))+
  geom_smooth( aes(   age+1 ,data),se=F)+
  scale_y_continuous(limits=c(0,NA))+
  xlab("Age")+ylab("")+
...
p1=ggplot(as.data.frame(harvest(ices[["spr.27.3a4"]])))+
  geom_line(aes(year,data,col=ac(age)),size=1.2)+
  scale_y_continuous(limits=c(0,NA))+
...
p2=ggplot(as.data.frame(catch.sel(ices[["spr.27.3a4"]])))+
  geom_boxplot(aes(ac(age),data,fill=ac(age)))+
  geom_smooth( aes(   age+1 ,data),se=F)+
  scale_y_continuous(limits=c(0,NA))+
  theme_bw(20)+
...
p1=ggplot(as.data.frame(catch.wt(ices[["spr.27.3a4"]])/stock.wt(ices[["spr.27.3a4"]])))+
  geom_line(aes(year,data,col=ac(age)),size=1.2)+
...
p2=ggplot(as.data.frame(catch.wt(ices[["spr.27.3a4"]])/stock.wt(ices[["spr.27.3a4"]])))+
  geom_boxplot(aes(ac(age),data,fill=ac(age)))+
  geom_hline(aes(yintercept=1),linetype=2)+
  geom_smooth( aes(   age+1 ,data),se=F)+
  scale_y_continuous(limits=c(0,NA))+
...
```{r, cor}
dat=subset(as.data.frame(FLQuants(m =       m(ices[["spr.27.3a4"]]),
                                  wt=stock.wt(ices[["spr.27.3a4"]])^(1/3)),drop=T),!is.na(data))
...
sn=stock.n(ices[["spr.27.3a4"]])%/%yearMeans(stock.n(ices[["spr.27.3a4"]]))
sn=sn%-%yearMeans(sn)
...
cn=catch.n(ices[["spr.27.3a4"]])%/%yearMeans(catch.n(ices[["spr.27.3a4"]]))
cn=cn%-%yearMeans(cn)
